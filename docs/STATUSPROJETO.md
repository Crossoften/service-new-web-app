...
> **Próximas (ordem da seção 10 do doc):** **17** aceite/recusa de orçamento — inclui `PATCH /budgets/:id/reject`
> + `acceptedAt`/`rejectedAt`/`rejectReason` (§8.8) · **18** gorjeta+cupom na sacola (§8.9 — ⚠️ `POST
